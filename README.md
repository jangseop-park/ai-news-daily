...
- [home-assistant/core](https://github.com/home-assistant/core): 로컬 제어와 프라이버시를 우선으로 하는 오픈소스 홈 자동화
- [ansible/ansible](https://github.com/ansible/ansible): SSH를 통해 코드 배포부터 네트워크 설정, 클라우드 관리까지 자동화하는 IT 자동화 플랫폼
- [pytorch/pytorch](https://github.com/pytorch/pytorch): 강력한 GPU 가속을 지원하는 Python 동적 신경망 프레임워크
- [FoundationAgents/OpenManus](https://github.com/FoundationAgents/OpenManus): 완전 개방형 범용 AI 에이전트 프레임워크
...
- [대한민국 제도 100개를 한장씩 체계도로 만들었습니다](https://hosungseo.github.io/korea100/)
  AI를 활용해 한국 공공행정 100개 제도의 법령 구조를 한 장짜리 체계도로 시각화한 프로젝트. AI 리터러시의 새로운 방향 제시.
- [미첼 하시모토 인터뷰: Ghostty, Zig, 오픈소스 유지보수](https://alexalejandre.com/programming/interview-with-mitchell-hashimoto/)
  HashiCorp 창업자 미첼 하시모토의 터미널 에뮬레이터 Ghostty 개발, Zig 언어 채택, 오픈소스 유지보수 철학에 대한 인터뷰.
- [LLM 번아웃이 온 것 같아요](https://www.alecscollon.com/blog/llm-burnout/)
  매일 AI 도구를 사용하면서 AI 생성 콘텐츠 소비가 크게 늘었고 인지적 피로감이 쌓이는 현상에 대한 개발자의 성찰.
- [OpenAI GPT-5.6 출시 (Sol, Terra, Luna 모델)](https://openai.com/index/gpt-5-6/)
  OpenAI가 GPT-5.6 패밀리를 정식 출시. Sol, Terra, Luna 세 가지 모델 변형을 제공하며 추론 능력과 다양한 작업에 특화.
- [Lisp로 가는 길: 왜 Lisp인가](https://scotto.me/blog/2026-07-09-why-lisp/)
  현대 프로그래밍 패러다임에서 Lisp의 독특한 가치와 매력에 대한 탐구. 코드와 데이터의 동일성, 매크로 시스템의 강점 등 설명.
