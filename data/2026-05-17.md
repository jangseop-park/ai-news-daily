...
- [rohitg00/ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch): AI 엔지니어링을 처음부터 배우고 직접 구축하는 실습 가이드
- [HKUDS/CLI-Anything](https://github.com/HKUDS/CLI-Anything): 모든 소프트웨어를 에이전트 네이티브로 만드는 CLI 프레임워크
- [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official): Anthropic 공식 관리 고품질 Claude 플러그인 디렉토리
...
- [Datatype - 텍스트를 차트로 변환하는 가변 폰트](https://github.com/franktisellano/datatype)
  텍스트 문자를 데이터 시각화 차트로 변환하는 창의적인 오픈소스 가변 폰트
- [whichllm - 내 하드웨어에서 최고 성능 로컬 LLM 찾기](https://github.com/Andyyyy64/whichllm)
  사용자 하드웨어 사양에 맞춰 실제로 돌아가면서 최고 성능을 내는 로컬 LLM을 찾아주는 도구
- [SideQuick - 사이드 프로젝트 완주 도구](https://www.sidequick.co/)
  사이드 프로젝트를 시작만 하고 끝내지 못하는 문제를 해결하는 생산성 도구
- [Andrej Karpathy, Anthropic에 합류](https://twitter.com/karpathy/status/205675316)
  AI 분야 유명 연구자 Andrej Karpathy가 Anthropic에 합류한다고 발표