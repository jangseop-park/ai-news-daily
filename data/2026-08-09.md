...
- [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning): 프로젝트 기반으로 직접 만들며 배우는 튜토리얼을 큐레이션한 목록임.
...
- [지각된 음성의 해석 가능한 MEG 디코딩: 피질 소스와 인출을 이끄는 자극 특징](https://huggingface.co/papers/2608.01481)
  MEG 신호로 지각된 음성을 해석 가능하게 디코딩하고, 어떤 피질 소스·자극 특징이 인출을 이끄는지 분석함.
...
- [LLM은 '점프'할 수 없다](https://openreview.net/challenge?redirect=%2Fforum%3Fid%3DklU4737opt)
  현재 생성형 AI는 데이터에서 규칙을 찾는 귀납과 공리에서 결과를 끌어내는 연역은 잘하지만, 그 사이를 도약하는 '점프' 추론은 못한다고 지적함.
- [Orca — 여러 병렬 코딩 에이전트를 위한 오픈소스 ADE](https://github.com/stablyai/orca)
  여러 코딩 에이전트를 병렬로 돌리고 관리하는 오픈소스 에이전트 개발 환경(ADE)임.
- [AMD, 모델을 실리콘에 새기는 AI 칩 스타트업 Taalas 인수](https://www.theregister.com/systems/2026/08/06/amd-acquires-ai-chip-startup-taalas-to-boost-inference-performance-by-etching-models-into-silicon/5284344)
